...
const TroubleshootingPage = () => (
  ...
  >
    ...
    <DocsSection id="wrong-token" title="Record found, token differs">
      <DocsP>
        <DocsStrong>Diagnosis:</DocsStrong> <DocsCode>wrong_value</DocsCode> — a Domainify record
      ...
      <DocsUl>
        <li>
          ...
          <DocsLink href="/docs/api/regenerate-token">regenerated</DocsLink> — both mint a new
    ...
    <DocsSection id="no-record-yet" title="Still says no record">
      <DocsP>
        <DocsStrong>Diagnosis:</DocsStrong> <DocsCode>no_record</DocsCode> — the sources answered
      ...
      <DocsUl>
        ...
        <li>
          ...
          easy to do with multiple domains in one registrar account.
        </li>
        <li>
    ...
    <DocsSection id="dns-errors" title="We can’t reach your nameservers">
      <DocsP>
        <DocsStrong>Diagnosis:</DocsStrong> <DocsCode>dns_error</DocsCode> — every source errored:
