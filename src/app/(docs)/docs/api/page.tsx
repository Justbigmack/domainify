...
import { MethodLabel } from '@/components/docs/method-label'
import { DocsCode, DocsLink, DocsP, DocsStrong } from '@/components/docs/prose'
import { ENDPOINT_DOCS } from '@/lib/docs/api-reference'
import { COOLDOWN_ERROR_EXAMPLE, ERROR_SHAPE_EXAMPLE } from '@/lib/docs/api-examples'
