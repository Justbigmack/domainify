...
import { MethodLabel } from '@/app/(docs)/docs/_components/MethodLabel'
import { DocsCode, DocsLink, DocsP, DocsStrong } from '@/app/(docs)/docs/_components/Prose'
import { ENDPOINT_DOCS } from '@/lib/docs/apiReference'
import { COOLDOWN_ERROR_EXAMPLE, ERROR_SHAPE_EXAMPLE } from '@/lib/docs/apiExamples'
